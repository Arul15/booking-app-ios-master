...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    {
        logoImage = [UIImage imageNamed:@"map_marker_pickup"];
        placeholder = NSLocalizedString(@"address_search_pickup_hint", @"");
        searchText = self.searchContext.searchPickupText;
    }
    else
    {
        logoImage = [UIImage imageNamed:@"map_marker_dropoff"];
        placeholder = NSLocalizedString(@"address_search_dropoff_hint", @"");
        searchText = self.searchContext.searchDropoffText;
    }

    _locationTextField.placeholder = placeholder;
    ...
    if (searchText)
    {
        _locationTextField.text = searchText;
