...
{
    if ([CabOfficeSettings disableDropoffLocation])
    {
        return NO;
    }
    else
...
+ (BOOL)pickupOrDropoffMustBeStation
{
    NSDictionary *s = [CabOfficeSettings cabOfficeDefaults];
    NSNumber* r = s[@"caboffice_settings_pickup_or_dropoff_must_be_station"];
    return [r boolValue];
}

+ (BOOL)disableDropoffLocation
{
    NSDictionary *s = [CabOfficeSettings cabOfficeDefaults];
    NSNumber* r = s[@"caboffice_settings_disable_dropoff_location"];
    return [r boolValue];
}

+ (NSInteger)cancellationFeeTimeThreshold
{
    NSDictionary *s = [CabOfficeSettings cabOfficeDefaults];
    NSNumber* r = s[@"cabooffice_cancellation_fee_time_threshold"];
    return [r integerValue];
}
...
{
    NSDictionary *s = [CabOfficeSettings cabOfficeDefaults];
    NSNumber* r = s[@"caboffice_card_limit"];
    return [r integerValue];
}
