...
CGFloat const DAPagesContainerTopBarItemViewWidth = 160.;
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        self.font = [UIFont lightOpenSansOfSize:16];
    }
    return self;
}
...
- (UIButton *)addItemView
{
    ...
    [itemView setTitleColor:[UIColor searchDialogNotSelectedTitleColor] forState:UIControlStateNormal];
