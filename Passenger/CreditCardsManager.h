...
typedef void (^CardManagerUpdateBlock)(NSArray* cards, NSError* error);

@interface CreditCardsManager : NSObject

+ (CreditCardsManager*)getInstance;

@property (nonatomic, readonly) CreditCard* defaultCard;
